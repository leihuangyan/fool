...
Ext.define('test.module.entity', {
    ...
    fields: [
        ...
        {name: 'reimbursetotalamount', type: 'string'},
...
//定义strore
Ext.define('test.model.Store', {
    extend: 'Ext.data.Store',
    model: 'test.module.entity',
    pageSize: 10, // 数据集每页显示数量
    fields:['fid', 'subsidiary', 'paymentday','budgetitem','createtime','reimbursetotalamount','billstatus'],
    proxy : {
        type : 'ajax',
        actionMethods : {
            read : 'GET'
...
Ext.define('test.module.grid', {
    ...
    constructor : function(config) {
        ...
        me.store = Ext.create('test.model.Store', {
            pageSize : 10,
        });
        me.callParent([ cfg ]);
    }
